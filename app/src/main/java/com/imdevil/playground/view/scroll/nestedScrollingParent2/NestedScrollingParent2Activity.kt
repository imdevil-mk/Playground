package com.imdevil.playground.view.scroll.nestedScrollingParent2
...
class NestedScrollingParent2Activity :
    AppCompatActivity(R.layout.activity_nested_scrolling_parent2) {
